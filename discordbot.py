...
async def regin(ctx):
    if ctx.channel.id == 864846769351294976:
        ...
        embed.add_field(name='▼<@895325105884913736>',value='everyoneメンション、サーバーの招待リンク、クラッシュGIFをスパム。\n深夜のためサーバへの被害、メンバーへの被害ともに軽微の為、脅威度を以下に認定する。\n__評価値__:15\n__脅威クラス__:**E+**\n\n【備考】\n荒らし行為は確認されていないが、以下は該当ユーザーのサブアカウントとして判明しています。\n<@749524210925436970>\n<@838400028199878698>\n[画像1](https://cdn.discordapp.com/attachments/887112112630022165/903753237033807902/IMG_5652.png)\n[画像2](https://cdn.discordapp.com/attachments/887112112630022165/903753237306421349/IMG_5653.png)')
        await channel.send(embed=embed)
